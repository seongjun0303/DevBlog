...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)&& empty($address_err)&& empty($firstname_err)&& empty($lastname_err)&& empty($fullname_err)&& empty($expiration_err)&& empty($cardnumber_err)&& empty($cvc_err)&&empty($email_err)){
